...
#
# This file is part of the l1 periodogram.
#
...
# ------------------------------------------------------------------- #
    ...
    def l1_perio(self,
        ...
        if verbose >=1: 
            print('Weighting dictionary duration', time.clock() - start_time, "seconds")
...
#                       numerical_method = numerical_method, 
    ...
    def update_model(self,omegamax = None,
        ...
        if verbose >=1:
            print('Model creation duration', time.clock() - start_time, "seconds") 
